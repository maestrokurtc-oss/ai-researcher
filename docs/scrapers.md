...
- `selection_threshold` — optional 0–10 score threshold for this feed; overrides the profile threshold while an explicit runtime threshold still takes precedence
